...
<context>
    ...
    <message>
        ...
        <source>This makes it easier to send or receive ETcoin and reduces errors when typing in addresses manually.</source>
        <translation>Это облегчит отправку и получение ETcoin и снизит количество ошибок при ручном вводе адресов.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Поиск по ID транзакции, адресу, описанию, количеству или высоте блока</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <source>WARNING: Do not reuse your ETcoin keys on another fork, UNLESS this fork has key reuse mitigations built in. Doing so will harm your privacy.</source>
        <translation>ПРЕДУПРЕЖДЕНИЕ: Не используйте повторно свои ключи ETcoin на другом форке, ЕСЛИ ТОЛЬКО этот форк не имеет встроенные средства защиты от компрометации введенных ключей. Подобные действия могут повредить вашей конфиденциальности.</translation>
    </message>
    <message>
        <location filename="../pages/Keys.qml" line="85"/>
        <source>WARNING: Copying your seed to clipboard can expose you to malicious software, which may record your seed and steal your ETcoin. Please write down your seed manually.</source>
        <translation>ВНИМАНИЕ: Копирование вашей мнемонической фразы в буфер обмена может сопровождаться перехватом этих данных различным вредоносным программным обеспечением, которое отправит вашу мнемонику злоумышленнику, после чего ваши ETcoin могут быть украдены. Пожалуйста, вводите вашу мнемоническую фразу вручную с клавиатуры.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>(Аппаратный кошелёк - Секретный ключ траты (secret spend key) не доступен)</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Принимать или нет неподтвержденные транзакции - ваше дело. Скорее всего они будут подтверждены в ближайшее время, но все же есть вероятность что нет, поэтому при больших значениях Вы возможно захотите дождаться одного или нескольких подтверждений</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <source>Mining with your computer helps strengthen the ETcoin network. The more that people mine, the harder it is for the network to be attacked, and every little bit helps.

Mining also gives you a small chance to earn some ETcoin. Your computer will create hashes looking for block solutions. If you find a block, you will get the associated reward. Good luck!</source>
        <translation>Майнинг на вашем компьютере помогает укрепить сеть ETcoin. Чем больше людей майнят, тем сложнее атаковать сеть, каждый может помочь.

Майнинг также даёт маленький шанс получить ETcoin. Ваш компьютер будет создать хеши в поиске решения блока. Если вы найдёте блок, то получите награду. Удачи!</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <source>Embedded ETcoin version: </source>
        <translation>Встроенная версия ETcoin: </translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <source>Uses a third-party server to connect to the ETcoin network. Less secure, but easier on your computer.</source>
        <translation>Использовать сторонний узел для подключения к сети ETcoin. Менее безопасно, но более быстро и удобно.</translation>
    </message>
    <message>
        <location filename="../pages/settings/SettingsNode.qml" line="260"/>
        <source>To find a remote node, type &apos;ETcoin remote node&apos; into your favorite search engine. Please ensure the node is run by a trusted third-party.</source>
        <translation>Чтобы получить список удаленных нод, введите &apos;ETcoin remote node&apos; в вашем любимом поисковике. Пожалуйста, убедитесь, что выбранной ноде можно доверять.</translation>
    </message>
    <message>
...
Вы можете изменить пароль в настройках кошелька.</translation>
    ...
    <message>
        ...
        <source>Receive ETcoin for your business, easily.</source>
        <translation>Получайте ETcoin для вашего бизнеса, легко.</translation>
    </message>
    <message>
        <location filename="../pages/settings/SettingsWallet.qml" line="144"/>
        <source>Enter merchant mode</source>
        <translation>Войти в режим мерчанта</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <source>This page allows you to interact with the shared ring database. This database is meant for use by ETcoin wallets as well as wallets from ETcoin clones which reuse the ETcoin keys.</source>
        <translation>На этой странице можно взаимодействовать с общей базой данных RingDB. Эта база данных предназначается для использования кошельками ETcoin или их клонов, которые смогут повторно использовать ключи ETcoin.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <source>In order to obscure which inputs in a ETcoin transaction are being spent, a third party should not be able to tell which inputs in a ring are already known to be spent. Being able to do so would weaken the protection afforded by ring signatures. If all but one of the inputs are known to be already spent, then the input being actually spent becomes apparent, thereby nullifying the effect of ring signatures, one of the three main layers of privacy protection ETcoin uses.&lt;br&gt;To help transactions avoid those inputs, a list of known spent ones can be used to avoid using them in new transactions. Such a list is maintained by the ETcoin project and is available on the etcoin.xyz website, and you can import this list here.&lt;br&gt;Alternatively, you can scan the blockchain (and the blockchain of key-reusing ETcoin clones) yourself using the etcoin-blockchain-mark-spent-outputs tool to create a list of known spent outputs.&lt;br&gt;</source>
        <translation>Для того чтобы скрыть какие входы в транзакциях ETcoin потрачены, третья сторона не должна сообщать какие входы в кольце уже задействованы в трате. Ведь если это сделать, то это ослабит защиту, обеспечиваемую кольцевыми подписями. Если известно, что все, кроме одного из входов, уже потрачены, то фактически трата входа становится очевидной, тем самым аннулируется эффект кольцевых подписей, одного из трех основных уровней защиты конфиденциальности ETcoin.&lt;br&gt;Чтобы помочь транзакциям избежать траты этих входов, можно использовать список известных израсходованных выходов, чтобы избежать их использования в новых транзакциях. Такой список поддерживается проектом ETcoin и доступен на веб-сайте etcoin.xyz, и вы можете импортировать этот список здесь.&lt;br&gt;Кроме того, вы можете просканировать блокчейн ETcoin (и его клонов) самостоятельно, используя инструмент etcoin-blockchain-mark-spent-outputs, чтобы создать список известных потраченых выходов.&lt;br&gt;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <source>In order to avoid nullifying the protection afforded by ETcoin&apos;s ring signatures, an output should not be spent with different rings on different blockchains. While this is normally not a concern, it can become one when a key-reusing ETcoin clone allows you to spend existing outputs. In this case, you need to ensure this existing outputs uses the same ring on both chains.&lt;br&gt;This will be done automatically by ETcoin and any key-reusing software which is not trying to actively strip you of your privacy.&lt;br&gt;If you are using a key-reusing ETcoin clone too, and this clone does not include this protection, you can still ensure your transactions are protected by spending on the clone first, then manually adding the ring on this page, which allows you to then spend your ETcoin safely.&lt;br&gt;If you do not use a key-reusing ETcoin clone without these safety features, then you do not need to do anything as it is all automated.&lt;br&gt;</source>
        <translation>Чтобы избежать аннулирования защиты, предоставляемой кольцевыми подписями ETcoin, выход не должен быть потраченным с другими значениями размера кольца и на других блокчейнах. Хотя, как правило, это не является проблемой, в некоторых случаях повторное использование ключей ETcoin позволяет потратить существующие выходы. В таких случаях вам необходимо позаботиться, чтобы эти существующие выходы использовали одно и то же кольцо в обеих блокчейнах.&lt;br&gt;Это может быть сделано автоматически с помощью любого программного обеспечения для повторного использования ключей от ETcoin-клонов, и даже если эти клоны не предоставляют подобную защиту, вы все еще можете проверить, что ваши транзакции защищены, путем ручного введения размера кольца на этой странице, которая позволит вам потратить ваши ETcoin безопасно.&lt;br&gt;Если вы не используете программное обеспечения от ETcoin-клонов, вам ничего не нужно делать, так как все будет сделано автоматически.&lt;br&gt;</translation>
    </message>
    <message>
        <location filename="../pages/SharedRingDB.qml" line="279"/>
        <source>This records rings used by outputs spent on ETcoin on a key reusing chain, so that the same ring may be reused to avoid privacy issues.</source>
        <translation>Здесь записываются кольца, используемые выходами, проводимыми на ETcoin, в цепочке повторного использования ключей, так что одно и то же кольцо можно использовать повторно, чтобы избежать проблем с конфиденциальностью.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <source>Enter the ETcoin Address (example: 44AFFq5kSiGBoZ...)</source>
        <translation>Введите адрес ETcoin (например: 44AFFq5kSiGBoZ...)</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <source>ETcoin sent successfully</source>
...
Пожалуйста, обновитесь или подключитесь к другому демону</translation>
    ...
    <message>
        ...
        <translation>Адрес недействительный.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <source>Spendable funds: %1 ET. Please wait ~%2 minutes for your whole balance to become spendable.</source>
        <translation>Отправляемая сумма: %1 ET. Пожалуйста, подождите ~%2 минут чтобы весь ваш баланс стал доступен для отправки.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Содержание описания соответствует формату long payment ID.           Пожалуйста, не вставляйте long payment ID в поле описания, ваши средства могут быть потеряны.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Long payment ID устарели.           Long payment ID не были зашифрованы на блокчейне и могут повредить вашей конфиденциальности.           Если отправителю все еще требуется long payment ID, пожалуйста, уведомите его об этом.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <source>Spend ET from a cold (offline) wallet</source>
        <translation>Потратить ET из оффлайн кошелька</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <source>New ETcoin version v%1 is available.</source>
        <translation>Доступна новая версия ETcoin v%1.</translation>
    </message>
    <message>
        <location filename="../components/UpdateDialog.qml" line="98"/>
        <source>Please visit etcoin.xyz for details</source>
        <translation>Пожалуйста посетите etcoin.xyz для подробной информации</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Введите сильный пароль</translation>
    </message>
    <message>
        <location filename="../wizard/WizardAskPassword.qml" line="90"/>
...
<context>
    ...
    <message>
        ...
        <translation>Высота блока для восстановления</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <source>To be able to communicate with the ETcoin network your wallet needs to be connected to a ETcoin node. For best privacy it&apos;s recommended to run your own node.</source>
        <translation>Чтобы иметь возможность обмениваться данными с сетью ETcoin, ваш кошелек должен быть подключен к ноде ETcoin. Для лучшей конфиденциальности рекомендуется запустить свою собственную ноду.</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <source>Additionally, you may specify a bootstrap node to use ETcoin immediately.</source>
        <translation>Кроме того, вы можете указать ноду быстрой загрузки, чтобы немедленно начать пользоваться ETcoin.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <source>Welcome to ETcoin</source>
        <translation>Добро пожаловать в ETcoin</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <source>Choose this option if this is your first time using ETcoin.</source>
        <translation>Выберете эту опцию, если вы впервые пользуетесь ETcoin.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <source>Connect your hardware wallet to create a new ETcoin wallet.</source>
        <translation>Создать новый кошелек, подключившись к вашему аппаратному кошельку ETcoin.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <source>Temporary use of remote nodes is useful in order to use ETcoin immediately (hence the name bootstrap), however be aware that when using remote nodes (including with the bootstrap setting), nodes could track your IP address, track your &quot;restore height&quot; and associated block request data, and send you inaccurate information to learn more about transactions you make.</source>
        <translation>Временное использование удаленных нод полезно для немедленного использования ETcoin (отсюда название &quot;начальной загрузки&quot;), однако помните, что при использовании удаленных узлов (включая настройку ноды начальной загрузки), узлы могут отслеживать ваш IP адрес, отслеживать вашу &quot;высоту восстановления&quot; и соответствующие данные запроса блока, и отправлять вам неточную информацию, чтобы узнать больше о совершаемых вами транзакциях.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <source>This mode is ideal for managing small amounts of ETcoin. You have access to basic features for making and managing transactions. It will automatically connect to the ETcoin network so you can start using ETcoin immediately.</source>
        <translation>Этот режим идеально подходит для управления небольшими суммами ETcoin. У вас есть доступ к основным функциям для совершения транзакций и управления ими. Программа автоматически подключится к сети ETcoin, чтобы вы сразу могли начать использовать ETcoin.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <source>To be able to communicate with the ETcoin network your wallet needs to be connected to a ETcoin node. For best privacy it&apos;s recommended to run your own node.

If you don&apos;t have the option to run your own node, there&apos;s an option to connect to a remote node.</source>
        <translation>Чтобы иметь возможность обмениваться данными с сетью ETcoin, ваш кошелек должен быть подключен к ноде ETcoin. Для лучшей конфиденциальности рекомендуется запустить свою собственную ноду.
...
Количество: </translation>
    ...
    <message>
        ...
        <translation>Хотите остановить локальный узел или оставить работать в фоновом режиме ?</translation>
    </message>
    <message>
...
может требоваться ваше подтверждение.</translation>
    ...
    <message>
        <location filename="../main.qml" line="967"/>
        <source>ETcoin sent successfully: %1 transaction(s) </source>
        <translation>ETcoin успешно отправлены: %1 транзакция(й) </translation>
    </message>
    <message>
    ...
    <message>
        ...
        <source>This address received %1 etcoin, with %2 confirmation(s).</source>
        <translation>Этот адрес получил %1 ET, с %2 подтверждениями.</translation>
    </message>
    <message>
        <location filename="../main.qml" line="1065"/>
        <source>Good signature</source>
    ...
    <message>
        ...
        <source>This address received %1 etcoin, but the transaction is not yet mined</source>
        <translation>Этот адрес получил %1 ET, но транзакции все еще не подтверждены майнерами</translation>
    </message>
    <message>
